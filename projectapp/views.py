...
#         if request.FILES.get("uploaded-image") is not None :
#             file_nm = request.FILES.get("uploaded-image")
#         else :
#             file_nm = ""
...
def setFileInsert(request) :
    try :
        ...
        if request.FILES.get("file-input") is not None :
            file_nm = request.FILES.get("file-input")
        else :
            file_nm = ""
